...
async function fixture(t,options={}){
 ...
 const env={ADMIN_PASSWORD:password,STAFF_PASSWORD:'staff-test-password-long',CREATOR_PASSWORD:'creator-test-password-long',APP_ORIGIN:'http://localhost:3000',DATA_FILE:join(dir,'db.sqlite'),...options.env};
