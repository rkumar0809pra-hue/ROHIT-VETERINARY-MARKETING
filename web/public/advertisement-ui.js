...
let brief={title:'',topic:'',presenter:'',presenterType:'female',voice:'coral',voiceStyle:'warm',duration:'30',ratio:'9:16',language:'Hindi'};
...
export async function advertisementClick(el,c){
 if(el.hasAttribute('data-ad-prompt')){
  if(busy)return true;
  brief=Object.fromEntries(new FormData(document.getElementById('ad-create')));
